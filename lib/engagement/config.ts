...
export const qualityFilters = {
    ...
    max_tweet_age_minutes: 60,       // Extended to 1 hour for more opportunities
    min_tweet_likes: 0,              // Lower threshold for very recent tweets
    max_tweet_likes: 50000,          // Higher threshold for popular influencers
    min_text_length: 20,             // Reduced to catch more tweets (was 40)
    lookback_minutes: 60,            // Extended to match max age window
